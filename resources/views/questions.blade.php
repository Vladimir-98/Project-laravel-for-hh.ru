...
@endif
@section('canonical', url('/'.$lang_canonical.'questions'))
@section('data-form', 'Заявка со страницы вопросов.')
        ...
        <div class="container">
            <div class="page-breadcrumb">
                <div>
                    ...
                    <span>{{ ucfirst(__('main.questions')) }}</span>
                </div>
            </div>
            <div class="columns catalog-block">
                <div class="left">
                    <div class="block">
                        <div id="catalogData" class="catalog-apartments">
                ...
                <div class="right">
                    <div class="sidebar" id="boxFilter">
                        @include('layouts.sidebar', [$populars, $questions])
                    </div>
                </div>
            </div>
        </div>
