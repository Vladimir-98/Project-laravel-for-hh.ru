...
<div class="card-form ">
    ...
    <form id="adminForm"
          action="{{ url('admin/projects/show/description-update') }}"
          method="POST">
        <input type="hidden" name="description_gable_id" value="{{ $project->id }}">
        <input type="hidden" name="description_gable_type" value="{{ __('App\Models\Admin\Project') }}">
        <input type="hidden" value="{{ $project->id }}" name="description" id="currentPage">
{{--        <input type="hidden" name="description_id" value="@if(isset($project->description)){{ $project->description->id }}@endif">--}}
        ...
        <div class="form-group" style="position: relative">
            ...
            <input class="custom_input" name="title_en" id="title_en" type="text"
                   @isset($project->description)value="{{ $project->description->title_en }}"@endisset>
        </div>
        <div class="form-group" style="position: relative">
            ...
            <div class="editor text-paragraph" contenteditable="true" onblur="addDataTextarea(this)"
                ...
                <div
                    class="textEdit">@isset($project->description){!! $project->description->description_en !!}@else{{ __('Описание...') }}@endisset</div>
            </div>
            <textarea class="custom_input" name="description_en" id="description_en" type="text"
                      style="display: none">
                @isset($project->description){{ $project->description->description_en }}@endisset
            </textarea>
        </div>
        ...
        <div class="form-group" style="position: relative">
            ...
            <input class="custom_input" name="title_tr" id="title_tr" type="text"
                   @isset($project->description)value="{{ $project->description->title_tr }}"@endisset>
        </div>
        ...
        <div class="form-group" style="position: relative">
            ...
            <div class="editor text-paragraph" contenteditable="true" onblur="addDataTextarea(this)"
                ...
                <div
                    class="textEdit">@isset($project->description){!! $project->description->description_tr !!}@else{{ __('Описание...') }}@endisset</div>
            </div>
            <textarea class="custom_input" name="description_tr" id="description_tr" type="text"
                      style="display: none">
                @isset($project->description){{ $project->description->description_tr }}@endisset
            </textarea>
        </div>
        ...
        <div class="form-group" style="position: relative">
            ...
            <input class="custom_input" name="title_ru" id="title_ru" type="text"
                   @isset($project->description)value="{{ $project->description->title_ru }}"@endisset>
        </div>
        <div class="form-group" style="position: relative">
            ...
            <div class="editor text-paragraph" contenteditable="true" onblur="addDataTextarea(this)"
                ...
                <div
                    class="textEdit">@isset($project->description){!! $project->description->description_ru !!}@else{{ __('Описание...') }}@endisset</div>
            </div>
            <textarea class="custom_input" name="description_ru" id="description_ru" type="text"
                      style="display: none">
                @isset($project->description){{ $project->description->description_ru }}@endisset
            </textarea>
        </div>
        <!====== FOOTER BUTTON ======>
