...
<div class="card-form">
    ...
    <form id="adminForm"
          action="{{ url('admin/projects/show/meta-update') }}"
          method="POST">
        <input type="hidden" name="meta_gable_id" value="{{ $project->id }}">
        <input type="hidden" name="meta_gable_type" value="{{ __('App\Models\Admin\Project') }}">
        <input type="hidden" value="{{ $project->id }}" name="meta" id="currentPage">
...
{{--                   @isset($project->meta)value="{{ $project->meta->title_meta_en }}"@endisset>--}}
{{--        </div>--}}
        <div class="form-group" style="position: relative">
            ...
            <div class="editor text-paragraph" contenteditable="true"
                ...
                <div
                    class="textEdit">@isset($project->meta){!! $project->meta->description_meta_en !!}@else{{ __('Описание...') }}@endisset</div>
            </div>
            <textarea class="custom_input" name="description_meta_en" id="description_meta_en" type="text" style="display: none">
                @isset($project->meta){{ $project->meta->description_meta_en }}@endisset
            </textarea>
        </div>
...
{{--                   @isset($project->meta)value="{{ $project->meta->title_meta_tr }}"@endisset>--}}
{{--        </div>--}}
        <div class="form-group" style="position: relative">
            ...
            <div class="editor text-paragraph" contenteditable="true" onblur="addDataTextarea(this)"
                ...
                <div
                    class="textEdit">@isset($project->meta){!! $project->meta->description_meta_tr !!}@else{{ __('Описание...') }}@endisset</div>
            </div>
            <textarea class="custom_input" name="description_meta_tr" id="description_meta_tr" type="text"
                      style="display: none">
                @isset($project->meta){{ $project->meta->description_meta_tr }}@endisset
            </textarea>
        </div>
...
{{--                   @isset($project->meta)value="{{ $project->meta->title_meta_ru }}"@endisset>--}}
{{--        </div>--}}
        <div class="form-group" style="position: relative">
            ...
            <div class="editor text-paragraph" contenteditable="true" onblur="addDataTextarea(this)"
                 style="min-height: 150px">
                <div
                    class="textEdit">@isset($project->meta){!! $project->meta->description_meta_ru !!}@else{{ __('Описание...') }}@endisset</div>
            </div>
            <textarea class="custom_input" name="description_meta_ru" id="description_meta_ru" type="text"
                  style="display: none">
                                    @isset($project->meta){{ $project->meta->description_meta_ru }}@endisset
                                </textarea>
        </div>
...
{{--                   @isset($project->meta)value="{{ $project->meta->canonical }}"@endisset>--}}
{{--        </div>--}}
        <!====== FOOTER BUTTON ======>
