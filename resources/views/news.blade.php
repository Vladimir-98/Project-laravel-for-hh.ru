...
@endif
@section('canonical', url('/'.$lang_canonical.'news'))
@section('data-form', 'Заявка со страницы новостей.')
        ...
        <div class="container">
            <div class="page-breadcrumb">
                <div>
                    ...
                    <span>{{ ucfirst(__('main.news')) }}</span>
                </div>
            </div>
            <div class="columns catalog-block">
                ...
                <div class="right">
                    <div class="sidebar" id="boxFilter">
                        @include('layouts.sidebar', [$populars, $news])
                    </div>
                </div>
            </div>
        </div>
