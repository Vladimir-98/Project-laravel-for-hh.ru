...
@endif
@section('canonical', url('/'.$lang_canonical.'apartments'))
@section('data-form', 'Заявка со страницы квартир.')
        ...
        <div class="container catalog-apartments">
            <div class="page-breadcrumb">
                <div>
                    ...
                    <span>{{ ucfirst(__('main.selection_of_real_estate')) }}</span>
                </div>
            </div>
